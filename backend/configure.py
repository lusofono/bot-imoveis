...
from .ai import KNOWLEDGE_RULE, describe
from .rules import EMAIL, REFERENCE
from .store import load_json, load_profiles, load_voice, save_json

# The published examples (fictitious data) a new owner or property starts from.
...
def example_profile(folder):
    ...
    return load_json(local if local.exists() else TEMPLATES / "profile.example.json", {})
