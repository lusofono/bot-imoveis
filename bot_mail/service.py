...
from .properties import (KNOWLEDGE_RULE, build_profile, check_profile, clean_property, describe, instructions,
                         load_profiles, load_voice, prepare, route)
...
class MailService:
    ...
    def save_property(self, fields):
        ...
        with locked(self.folder):
            ...
            profile = build_profile(fields, account, template, profiles.get(ref))
